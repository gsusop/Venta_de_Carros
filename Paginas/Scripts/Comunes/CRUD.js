...
async function LlenarTablaXServiciosAuth(URLServicio, TablaLlenar) {
    ...
    try {
        ...
        //const colsToRemove = ["Detalle_Servicio", "Servicios_Tipos", "ID_Servicio"];
        const columNames = Object.keys(Rpta[0]) //.filter(i => !colsToRemove.includes(i));
