...
namespace Venta_de_Carros.Clases
{
    public class clsEmpleado
    {
        ...
        public string Actualizar()
        {
            ...
            ITM_Ventas.Empleado.AddOrUpdate(Empleado);//Actualiza un emplado en la tabla EMPLEADO
            ITM_Ventas.SaveChanges();
            return "Se actualizó correctamente";
        }
        public Empleado Consultar(string Documento)
        {
            Empleado clt = ITM_Ventas.Empleado.FirstOrDefault(e => e.Numero_Documento == Documento);//consulta un Empleado por su documento
            return clt;
        }
        ...
        public string Eliminar()
        {
            try
            {
                ...
                ITM_Ventas.Empleado.Remove(clt);//Elimina un Empleado de la tabla Empleado
